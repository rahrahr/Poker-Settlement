...
names_map = json.load(open('copy.json'))
def convert_name(s):
...
class Parser:
    ...
    def parse_line(self, row):
        ...
        if "created the game with a stack of" in line or "The admin approved" in line:
            player_name = convert_name(line.split('"')[1])
            ...
            players = [convert_name(x.split('"')[1]) for x in entries]
            ...
            if "dead button" in line:
                ...
                dealer_name = convert_name(line.split('"')[1])
            ...
            player_name = convert_name(match.group(1))
            ...
            winner_name = convert_name(match.group(1))
